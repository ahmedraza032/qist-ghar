    ...
    <div className="flex min-h-[100dvh] bg-muted/30">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-background border-r border-border fixed inset-y-0">
        <div className="flex items-center h-16 px-6 border-b border-border">
          <Link href="/admin" className="font-bold text-lg flex items-center">
            <Image src="/logo-cropped.png" alt="QistGhar Logo" width={420} height={140} className="h-10 md:h-[40px] w-auto object-contain mix-blend-multiply" />
          </Link>
        </div>
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-border">
          <Link href="/admin" className="font-bold text-lg flex items-center">
            <Image src="/logo-cropped.png" alt="QistGhar Logo" width={420} height={140} className="h-10 w-auto object-contain mix-blend-multiply" />
          </Link>
